...
public class AboutusPage_PageEditor_CustomInitiative extends Basedriver{
	...
	//Testcase for Custom Initiative Hero Image Left in Page Editor mode
	@Test
	public static void Initiative_LeftHeroImage() throws InterruptedException{
		try{
			...
			Opr_PageEditor_AboutUs.createCustomInitiativeLayout("InitiativeLeftHeroImage");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("InitiativeLeftHeroImage", "PageEditor");
		}catch(Exception e){
	...
	public static void Initiative_RightHeroImage() throws InterruptedException{
		try{
			...
			Opr_PageEditor_AboutUs.createCustomInitiativeLayout("InitiativeRightHeroImage");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("InitiativeRightHeroImage", "PageEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly " + e.getLocalizedMessage());
		}
	...
	public static void Initiative_RightHeroVideo() throws InterruptedException{
		try{
			...
			Opr_PageEditor_AboutUs.createCustomInitiativeLayout("InitiativeRightHeroVideo");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("InitiativeRightHeroVideo", "PageEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly " + e.getLocalizedMessage());
		}
	...
	public static void Initiative_LeftHeroVideo() throws InterruptedException{
		try{
			...
			Opr_PageEditor_AboutUs.createCustomInitiativeLayout("InitiativeLeftHeroVideo");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("InitiativeLeftHeroVideo", "PageEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly " + e.getLocalizedMessage());
		}
