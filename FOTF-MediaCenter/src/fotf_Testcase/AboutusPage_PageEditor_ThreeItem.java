...
public class AboutusPage_PageEditor_ThreeItem extends Basedriver{
	...
	public static void AboutUs_ThreeItemsThreeColumns() throws InterruptedException {
		try{
			...
			Opr_PageEditor_AboutUs.createLayout("3Items3Columns");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("3Items3Columns", "PageEditor");
		}catch(Exception e){
	...
	public static void AboutUs_ThreeItemsStackedImageLeft() throws InterruptedException {
		try{
			...
			Opr_PageEditor_AboutUs.createLayout("StackedImageLeft");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("StackedImageLeft", "PageEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly");
		}
	...
	public static void AboutUs_ThreeItemsThreeColumnsLinksOverlaid() throws InterruptedException {
		try{
			...
			Opr_PageEditor_AboutUs.createLayout("3ColumnsLinksOverlaid");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("3ColumnsLinksOverlaid", "PageEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly");
		}
