...
public class AboutusPage_ContentEditor_SixItem extends Basedriver{
	...
	public static void AboutUs_SixItemsThreeColumns() throws InterruptedException {
		try{
			...
			Opr_Sitecore_AboutusDatasource.AboutUsDatasource("6Items3Columns");
			Opr_ContentEditor_AboutUs.createLayout("6Items3Columns");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("6Items3Columns", "ContentEditor");
		}catch(Exception e){
	...
	public static void AboutUs_SixItemsSixColumns() throws InterruptedException {
		try{
			...
			Opr_ContentEditor_AboutUs.createLayout("6Items6Columns");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("6Items6Columns", "ContentEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly " + e.getLocalizedMessage());
		}
	...
	public static void AboutUs_SixItemsSixColumnsWithText() throws InterruptedException {
		try{
			...
			Opr_ContentEditor_AboutUs.createLayout("6Items6ColumnsWithText");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("6Items6ColumnsWithText", "ContentEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly " + e.getLocalizedMessage());
		}
	...
	public static void AboutUs_SixItemsTwoColumns() throws InterruptedException {
		try{
			...
			Opr_ContentEditor_AboutUs.createLayout("6Items2Columns");
			Opr_Sitecore_AboutUs_Assert.AssertAboutus("6Items2Columns", "ContentEditor");
		}catch(Exception e){
			Driver.navigate().refresh();
			log.fatal("TEST METHOD FAILED: Terminated Abruptly " + e.getLocalizedMessage());
		}
